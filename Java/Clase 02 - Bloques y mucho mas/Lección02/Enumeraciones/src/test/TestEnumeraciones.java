...
//        indicarDiaSemana(Dias.LUNES);//Las enumeraciones se tratan como cadenas
        ...
        System.out.println("No. de paises en el 1mer. continente: "
                +Continentes.AFRICA.getPaises());
        System.out.println("No. de habitantes en el 1mer. continente: "
        ...
        System.out.println("Continente No. 6: "+Continentes.ANTARTIDA);
        System.out.println("No. de paises en el 6to. continente: "
                +Continentes.ANTARTIDA.getPaises());
        System.out.println("No. de habitantes en el 6to. continente: "
                +Continentes.ANTARTIDA.getHabitantes());
