...
console.log("\nPRUEBA DE POLIMORFISMO CON FUNCIÓN ");
imprimirDispositivo(raton1);        // Llama a toString() de Raton
imprimirDispositivo(teclado1);      // Llama a toString() de Teclado
imprimirDispositivo(monitor1);      // Llama a toString() de Monitor
imprimirDispositivo(computadora1);  // Llama a toString() de Computadora
